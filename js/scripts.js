function convertNumeral(number) {
  ...
  for (var i = 0; number > 0; i++) {
    var numeralCount = 0;
    if (((numberArray[i].toString().charAt(0) === "1") && (number.toString().charAt(0) === "9") && (number > numberArray[i+1])) || ((numberArray[i].toString().charAt(0) === "1") && (number.toString().charAt(1) === "9") && (number > numberArray[i+1]))) {
